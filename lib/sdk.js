...
_.extend(Liq.prototype, {
    ...
    api: function (url, params, next) {
      ...
      data = new Buffer(JSON.stringify(_.extend(params, {public_key: public_key}))).toString('base64');
      toEncode = private_key + data + private_key;
      ...
      post_data = "data=" + data + "&signature=" + signature + "";
